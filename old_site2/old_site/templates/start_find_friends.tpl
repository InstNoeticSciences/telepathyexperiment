<h1 class="header">{$step4}</h1>
<p>{$invite_paragraph}</p>
<form method="post" action="start_find_friends">
...
(http://gozub.com/message/{$message->id})<br /><br />
...
<p class="mid"><a href="profile/{$logged_user->username}" class="continue">{$link_finish}</a></p>
