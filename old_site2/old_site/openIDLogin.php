...
if(isset($_GET['token']) && $_GET['token'] ) { 
	...
	$token = $_GET['token'];
	$rpx = new RPX('d6045a2fca1d912a3cd0a37d3f0586f97696768', 'https://rvapp.rpxnow.com/');
	...
	//print_r($arr);
	//print_r('</pre>');
	//echo '<a href="http://www.websitedesignoutsourcing.info/test/rpx/">Back</a>';
}
...
<a class="rpxnow" onclick="return false;"
   href="https://revou.rpxnow.com/openid/v2/signin?token_url=http://www.websitedesignoutsourcing.info/test/rpx/">
  Sign In
</a>
</body>
</html>
