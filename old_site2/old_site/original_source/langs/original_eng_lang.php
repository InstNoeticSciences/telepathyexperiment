...
// File Created:09:29:16 13.01.2010
...
define(alert_message_group, "Please select SubGroup!");
...
define(buy, "BUY");
define(buying_instruction, "To buy more choose how many sms credits you like to buy and press the BUY button.");
...
define(confirmation_mail, "Hello #username! You have just joined ReVou. Click on the link below to complete your registration: #link Follow the instructions to activate your MSN or Gtalk. It is that simple! Then invite your friends to join also and ask them to add you as a friend");
...
define(default_message_from_admin, "Welcome to ReVou, we hope that you will enjoy the site and if you have any questions, go to the HELP section or send us an e-mail by visiting the Contact Us section.");
...
define(err_about_me_too_long, "The about me text should not be longer than 200 characters.");
...
define(err_account_inactive, "Account is inactive. To activate your account using the ling you got in the confirmation email. If you did not receive the email, please check your spam folder.");
...
define(err_email_confirmation_needed, "If you want to log in, you have to activate your account using the link you got in the confirmation email. If you did not receive the email, please check your spam folder.");
...
define(err_interests_too_long, "The interests text should not be longer than 200 characters.");
...
define(err_msg_too_long, "The message is too long. It cannot exceed 140 characters.");
define(err_password_mismatch, "The password and its confirmation do not match.");
...
define(follow_ok, "You are following #username now");
define(forgot_header, "Forgot your password?");
define(forgot_paragraph, "If you do not remember your password, please write your email address and your password will be sent to it immediately");
define(friends1, "Friends of ");
define(friends2, "");
define(friends_of1, "Friends of");
define(friends_of2, "");
define(friend_search, "Search friends or group");
define(from, "from");
define(gateway_info, "Our SMS gateway number is: ");
define(groups_all_label, "All Groups");
define(groups_label, "Groups");
define(group_join_label, "Join to group");
define(group_label, "Group");
define(group_leave_label, "Leave group");
define(group_members, "Group members");
define(hello, "Hello");
...
define(label_flag_send_message, "Send messages to my twitter.com account");
define(label_follow, "Follow");
define(label_full_name, "Full name:");
define(label_groups, "Your groups:");
...
define(label_search_group, "Search group");
...
define(main_header, "Tell the world what you are doing at this moment!");
...
define(my_groups_header, "My groups");
define(my_im_explanation, "Activating your IM will enable you to post messages by it and to receive other peoples messages and notifications.");
...
define(my_mobile_text, "Specify your mobile number (including the +xx country code) to send and receive messages and notifications to and from ReVou! Be always up to date with what is gong on!");
...
define(nudge, "Hello, Want to write something at ReVou.com? I cannot wait!");
...
define(profile_tab_with_friends, "Your friend's messages");
...
define(refresh_warning, "If the picture did't change, refresh the page using Ctrl+F5");
...
define(select_group_default, "Without group");
...
define(sms_limit_text, "To save on SMS credits you can set a limit of SMS that you can send/receive. This limit can be changed or reset anytime.");
...
define(sticker_js_comment, "Do you want something simpler that you will be able to customize using CSS? Paste this code into your website/blog:");
define(tab_group_top10, "TOP10 Groups");
define(tab_picture_set, "Image library");
define(tab_popular, "Most popular");
define(tab_recent, "Most recent");
define(tab_upload, "Upload");
define(telepathy-exper-1, "telepathy-exper-1");
define(text_on_black, "");
define(tile_both, "Tile horizontally and vertically");
define(tile_h, " Tile horizontally");
define(tile_no, "Do not tile");
...
define(twitter_com_account_header, "Your Twitter.com account");
define(twitter_com_account_password, "Password");
define(twitter_com_account_username, "User name");
...
define(you_are_sure, "You are sure?");
